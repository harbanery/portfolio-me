...
/**
 * Client view of the 404 page (night-ocean backdrop, editorial heading,
 * back button). Isolated from `app/not-found.tsx` so that file can stay a
 * server component and opt into dynamic rendering — required by the
 * nonce-based CSP (the prerendered 404 HTML would carry no nonce and its
 * scripts would be blocked by `strict-dynamic`).
 */
const NotFoundView = () => {
