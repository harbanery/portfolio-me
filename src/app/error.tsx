  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-50 text-center px-4 animate-[rise-in_2s_ease-out_1s_both]">
        ...
        <h2 className="mb-6 font-inter font-extrabold text-white leading-[1.02] tracking-tight text-[clamp(2.25rem,6vw,4.75rem)] animate-[pop-in_1s_cubic-bezier(0.34,1.56,0.64,1)_2s_both]">
          <span className="block">Something went</span>
          <span className="block">wrong.</span>
        </h2>

        <p className="mb-10 max-w-md text-lg md:text-xl font-neue-haas font-light tracking-wider leading-relaxed text-gray-400 animate-[soft-fade_1s_ease-out_2.5s_both]">
          An unexpected error occurred while loading this page. Please try
          again — if the problem persists, come back later.
        </p>
