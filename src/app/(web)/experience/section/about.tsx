        ...
        <div className="flex flex-col gap-8 items-center">
          <div className="w-full">
            <h2
              data-aos="fade-right"
              data-aos-delay="200"
              className="text-5xl lg:text-7xl font-neue-haas text-center lg:text-left text-white font-light mb-12 transition-all duration-300"
            >
              My Career Journey
            </h2>
          </div>
          <div
            data-aos="fade-left"
            data-aos-delay="200"
            className="relative w-full px-0 md:px-[6%] lg:pl-[32%] lg:pr-0"
          >
            <div
              // data-aos="fade-right"
              // data-aos-delay="250"
              className="text-lg text-center lg:text-right text-gray-300 font-neue-haas leading-relaxed space-y-3 paragraph-wrapper transition-all duration-300"
