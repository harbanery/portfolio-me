    ...
    <section id="others" className="py-12 px-4 bg-black">
      <div className="max-w-6xl mx-auto">
        <h2
          data-aos="fade-right"
          data-aos-delay="50"
          className="text-3xl md:text-4xl lg:text-5xl font-neue-haas text-white font-light mb-8 md:mb-10 lg:mb-20"
        >
          More Projects
        </h2>

        {useCarousel ? (
          <div data-aos="fade-zoom-in" data-aos-delay="50" className="relative">
